...
@MappedEntity("destinations")
@Index(name = "idx_destinations_location", columns = "location")
public record DestinationEntity(
    @Id
    @GeneratedValue
    Long id,
    ...
    @VectorIndex(
        name = "idx_destinations_description_embedding",
